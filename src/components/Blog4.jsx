      ...
      <div className="row">
        ...
        <div className="col-md-8 ps-5">
          ...
          <div className="position-relative">
            ...
            <div className="d-flex justify-content-center"><img className="h-50 w-50 img-fluid d-flex justify-content-center" src="/images/blog1/blog4 (5).jpg" alt="A picture of a Masala Dosa Bites topped with sliced onions, bell peppers, paneer tikka, and mozzarella cheese" />
              <div style={{ backgroundColor: "rgba(0, 0, 0, 0.5)" }} className="position-absolute bottom-0 w-50 py-1 d-flex flex-column justify-content-end text-white overlay">
          ...
          <div className="position-relative">
            ...
            <div className="d-flex justify-content-center"><img className="h-50 w-50 img-fluid d-flex justify-content-center" src="/images/blog1/blog4 (2).jpg" alt="A picture of an Fruit Chaat (Fruit Salad) topped with sliced potatoes, cauliflower florets, sliced onions, and plenty of mozzarella cheese" />
              <div style={{ backgroundColor: "rgba(0, 0, 0, 0.5)" }} className="position-absolute bottom-0 w-50 py-1 d-flex flex-column justify-content-end text-white overlay">
          ...
          <div className="position-relative">
            ...
            <div className="d-flex justify-content-center"><img className="h-50 w-50 img-fluid d-flex justify-content-center" src="/images/blog1/blog4 (3).jpg" alt="A picture of a Poha (Flattened Rice) topped with sliced onions, bell peppers, chicken tikka masala, and mozzarella cheese" />
              <div style={{ backgroundColor: "rgba(0, 0, 0, 0.5)" }} className="position-absolute bottom-0 w-50 py-1 d-flex flex-column justify-content-end text-white overlay">
          ...
          <div className="position-relative">
            ...
            <div className="d-flex justify-content-center"><img className="h-50 w-50 img-fluid d-flex justify-content-center" src="/images/blog1/blog4 (4).jpg" alt="A picture of a Paneer Roll with Soya Chaap Roll topped with sliced bananas, strawberries, marshmallows, and chocolate chips" />
              <div style={{ backgroundColor: "rgba(0, 0, 0, 0.5)" }} className="position-absolute bottom-0 w-50 py-1 d-flex flex-column justify-content-end text-white overlay">
