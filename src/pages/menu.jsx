  ...
  return (
    ...
    <div className="div-body">
      ...
      <div className="d-flex container-flex align-items-start">
        <div
          className="nav flex-column col-md-2 border-end me-1"
          id="v-pills-tab"
          role="tablist"
        ...
        >
          {categories.map((category) => (
            <button
              ...
              aria-selected={`${category === category[0] ? "true" : "false"}`}
            >{`${category}`}</button>
          ))}
        </div>
        ...
        <div className="container-flex d-flex w-100 justify-content-center">
          <div className="tab-content col-md-11" id="v-pills-tabContent">
            {categories.map((category) => (
              <div
                className={`tab-pane fade ${category} ${
                  category === "Recommended" ? "active show" : ""
                }`}
                id={`v-pills-${category}`}
                role="tabpanel"
              ...
              >
                ...
                <div
                  className={`row d-flex justify-content-between p-1 ${category}`}
                >
                  {data.items.map((item) => {
